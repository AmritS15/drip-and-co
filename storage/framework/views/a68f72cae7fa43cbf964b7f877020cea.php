                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                 ...
                                 <li class="menu-item">
                                    <form metod="POST" action="<?php echo e(route('logout')); ?>" id="logout-form">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\drip-and-co-Najib-4\drip-and-co-Najib-4\resources\views/layouts/admin.blade.php ENDPATH**/ ?>